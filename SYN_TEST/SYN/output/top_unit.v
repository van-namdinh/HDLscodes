...
module top_unit ( i_clk, i_rst, i_lfsr_en, i_Seed_DV, i_Seed_Data, 
  ...
  DFFR_X1 \LFSR1/r_LFSR_reg[8]  ( .D(n286), .CK(i_clk), .RN(n780), .Q(
        leak_prn[7]), .QN(n771) );
  DFFR_X1 \LFSR1/r_LFSR_reg[1]  ( .D(n285), .CK(i_clk), .RN(n780), .Q(
        leak_prn[0]), .QN(n777) );
  DFFR_X1 \LFSR1/r_LFSR_reg[2]  ( .D(n284), .CK(i_clk), .RN(n780), .Q(
        leak_prn[1]) );
  DFFR_X1 \LFSR1/r_LFSR_reg[3]  ( .D(n283), .CK(i_clk), .RN(n780), .Q(
        leak_prn[2]), .QN(n772) );
  DFFR_X1 \LFSR1/r_LFSR_reg[4]  ( .D(n282), .CK(i_clk), .RN(n780), .Q(
        leak_prn[3]), .QN(n774) );
  DFFR_X1 \LFSR1/r_LFSR_reg[5]  ( .D(n281), .CK(i_clk), .RN(n780), .Q(
        leak_prn[4]), .QN(n762) );
  DFFR_X1 \LFSR1/r_LFSR_reg[6]  ( .D(n280), .CK(i_clk), .RN(n780), .Q(
        leak_prn[5]) );
  DFFR_X1 \LFSR1/r_LFSR_reg[7]  ( .D(n279), .CK(i_clk), .RN(n780), .Q(
        leak_prn[6]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[8]  ( .D(n278), .CK(i_clk), .RN(n780), .Q(
        reset_prn[7]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[1]  ( .D(n277), .CK(i_clk), .RN(n780), .Q(
        reset_prn[0]), .QN(n779) );
  DFFR_X1 \LFSR3/r_LFSR_reg[2]  ( .D(n276), .CK(i_clk), .RN(n780), .Q(
        reset_prn[1]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[3]  ( .D(n275), .CK(i_clk), .RN(n780), .Q(
        reset_prn[2]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[4]  ( .D(n274), .CK(i_clk), .RN(n780), .Q(
        reset_prn[3]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[5]  ( .D(n273), .CK(i_clk), .RN(n780), .Q(
        reset_prn[4]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[6]  ( .D(n272), .CK(i_clk), .RN(n780), .Q(
        reset_prn[5]) );
  DFFR_X1 \LFSR3/r_LFSR_reg[7]  ( .D(n271), .CK(i_clk), .RN(n780), .Q(
        reset_prn[6]) );
  DFFR_X1 \LFSR2/r_LFSR_reg[8]  ( .D(n270), .CK(i_clk), .RN(n780), .Q(
        syn_prn[7]), .QN(n775) );
  DFFR_X1 \LFSR2/r_LFSR_reg[1]  ( .D(n269), .CK(i_clk), .RN(n780), .Q(
        syn_prn[0]), .QN(n778) );
  DFFR_X1 \LFSR2/r_LFSR_reg[2]  ( .D(n268), .CK(i_clk), .RN(n780), .Q(
        syn_prn[1]) );
  DFFR_X1 \LFSR2/r_LFSR_reg[3]  ( .D(n267), .CK(i_clk), .RN(n780), .Q(
        syn_prn[2]), .QN(n773) );
  DFFR_X1 \LFSR2/r_LFSR_reg[4]  ( .D(n266), .CK(i_clk), .RN(n780), .Q(
        syn_prn[3]), .QN(n776) );
  DFFR_X1 \LFSR2/r_LFSR_reg[5]  ( .D(n265), .CK(i_clk), .RN(n780), .Q(
        syn_prn[4]), .QN(n761) );
  DFFR_X1 \LFSR2/r_LFSR_reg[6]  ( .D(n264), .CK(i_clk), .RN(n780), .Q(
        syn_prn[5]) );
  DFFR_X1 \LFSR2/r_LFSR_reg[7]  ( .D(n263), .CK(i_clk), .RN(n780), .Q(
        syn_prn[6]) );
  ...
  AOI22_X1 U751 ( .A1(leak_prn[4]), .A2(leak_prn[3]), .B1(n774), .B2(n762), 
        .ZN(n720) );
  ...
  AOI22_X1 U790 ( .A1(syn_prn[4]), .A2(syn_prn[3]), .B1(n776), .B2(n761), .ZN(
        n740) );
